...
Description: Function factory for pixel difference convolutional operations.
...
class Conv2d(nn.Module):
    """
    这是pdc卷积的包装类，进行参数记录和初始化操作，真实的pdc运算依赖于传入的pdc操作对象
    """
    ...
    def reset_parameters(self):
        """
        从0实现像素差卷积，初始化像素差卷积的weight和bias(如果设置的话)
        """
